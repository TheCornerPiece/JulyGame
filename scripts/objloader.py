...
class ObjFile:
    def finish_object(self):
        ...
        mesh = MeshData()
        idx = 0
        for verts, norms, tcs, texture_index in self.faces:
            for i in range(3):
                ...
                data = [v[0], v[1], v[2], n[0], n[1], n[2], t[0], t[1], texture_index]
                    ...
                    if values[0] == 'mtllib':
                        ...
                        for v in values[1:]:
                            ...
                            if len(w) >= 3 and len(w[2]) > 0:
                                ...
                                norms.append(-1)
                        self.faces.append((face, norms, texcoords, texture_index))
